                                    ...
                                    <div className="flex items-center gap-3">
                                      ...
                                      {isMe && !isSplitPayer && status === 'UNPAID' && (
                                        <button
                                          ...
                                          className="px-3 py-1 bg-primary text-primary-foreground font-bold rounded-full text-xs hover:opacity-90 transition-opacity cursor-pointer"
                                        >
                                          Mark Paid
                                        </button>
                                      )}
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          {tx.from === currentUser._id && (
                            <button
                              ...
                              className="px-3.5 py-1.5 bg-primary text-primary-foreground font-bold rounded-full text-xs shadow-sm cursor-pointer"
                            >
                              Pay Now
                            </button>
                          )}
